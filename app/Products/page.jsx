...
export default function Products() {
   ...
   const heading = "Products Page";
   const paragraph = "This is the about page of our Next.js application.";

   return (
      <main className="flex h-screen flex-col items-center justify-center bg-amber-800">
         <h1 ref={headingRef} className="text-9xl font-bold text-amber-200 ">
